                ...
                <div className="p-4 md:p-18 ">
                    ...
                    <Form>
                        ...
                        <Form.Item style={{ marginBottom: "3rem" }}>
                            ...
                            <DatePicker name="birthdate" onChange={handleDatePickerChange} style={{ backgroundColor: "transparent", color: "white" }} className="create-input" type="date" placeholder="เป็นประชากรบนโลกตั้งแต่" needConfirm />
                        </Form.Item>
                        ...
                        <Form.Item style={{ marginBottom: "20px", marginTop: "1rem" }}>
                            ...
                            <Input name="facebook" onChange={handleInputChange} value={formData.facebook_url || ""} prefix={<FaFacebookF />} style={{ backgroundColor: "transparent", color: "white", padding: "8px", fontSize: "16px", borderRadius: "10px" }} className="create-input" type="text" placeholder="www.facebook.com/*****" />
                        </Form.Item>
                        <Form.Item style={{ marginBottom: "20px" }}>
                            <label className='text-white text-lg'>YouTube</label>
                            <Input name="youtube" onChange={handleInputChange} value={formData.youtube_url || ""} prefix={<FaYoutube />} style={{ backgroundColor: "transparent", color: "white", padding: "8px", fontSize: "16px", borderRadius: "10px" }} className="create-input" type="text" placeholder="www.youtube.com/*****" />
                        </Form.Item>
                        <Form.Item style={{ marginBottom: "20px" }}>
